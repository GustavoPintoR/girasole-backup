...
class UpdateCadastralGroupRequest extends FormRequest
{
    /**
     ...
     */
    public function getUserId(int $currentUserId): int
    {
    ...
    /**
     * Check if owner is being changed
     */
    public function isOwnerChanging(int $currentUserId): bool
    {
        return $this->user()?->isSuperAdmin()
            && $this->has('user_id')
            && $this->input('user_id') !== $currentUserId;
    }
}
