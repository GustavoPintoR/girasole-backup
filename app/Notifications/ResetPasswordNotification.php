...
class ResetPasswordNotification extends Notification
{
    ...
    protected function buildMailMessage($url)
    {
        return (new MailMessage)
            ...
            ->line(__('notifications.reset_password_expiration', ['count' => config('auth.passwords.'.config('auth.defaults.passwords').'.expire')]))
            ->line(__('notifications.reset_password_no_action'));
    }
