...
class CustomFieldPolicy
{
    ...
    {
        return $user->can('read_custom_field');
    }
    ...
    {
        return $user->can('create_custom_field');
    }
    ...
    {
        return $user->can('update_custom_field');
    }
    ...
    {
       return $user->can('delete_custom_field');
    }
    ...
    {
       return $user->can('restore_custom_field');
    }
    ...
    {
        return $user->can('forceDelete_custom_field');
    }
}
