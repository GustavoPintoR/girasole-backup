...
function deleteItem() {
    if (selectedId.value) {
        router.delete(route('companies.destroy', selectedId.value), {
            preserveScroll: true,
            onSuccess: () => {
...
<template>
    <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem v-if="can.read_company" class="p-0">
                <Link :href="route('companies.show', props.company.id)" class="w-full">
            ...
            <DropdownMenuItem v-if="can.update_company" class="p-0">
                <Link :href="route('companies.edit', props.company.id)" class="w-full">
            ...
            <DropdownMenuItem v-if="can.delete_company && (currentUser && currentUser.id === props.company.owner?.id || currentUser.is_admin)" class="p-0">
                <Button variant="ghost" size="sm" :title="trans('ui.delete')" @click="confirmDelete(props.company.id)"
