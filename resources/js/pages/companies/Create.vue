...
//     return props.users.find(u => u.id === Number(form.owner_id));
// });
...
const selectedRegion = ref<ComboboxOption | null>(null);
const selectedProvince = ref<ComboboxOption | null>(null);
const selectedCity = ref<ComboboxOption | null>(null);
const selectedPostalCode = ref<ComboboxOption | null>(null);
const selectedCountry = ref<ComboboxOption | null>(
...
const selectedShippingRegion = ref<ComboboxOption | null>(null);
const selectedShippingProvince = ref<ComboboxOption | null>(null);
const selectedShippingCity = ref<ComboboxOption | null>(null);
const selectedShippingPostalCode = ref<ComboboxOption | null>(null);
...
<template>
    ...
    <Head :title="trans('ui.create_company')" />

    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="p-6 space-y-6">
            <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100">
                {{ trans('ui.create_company') }}
            </h1>
            ...
            <Card class="max-w-4xl">
                <CardContent>
                    <form @submit.prevent="submit" class="space-y-6">
                        ...
                        <!-- Owner select field -->
                        <div v-if="can.assign_company_owner" class="space-y-2 border-t pt-4">
                            ...
                            <Select v-model="form.owner_id" :required="true">
                                ...
                                <SelectContent>
                                    <SelectItem v-for="owner in props.users" :key="owner.id" :value="String(owner.id)">
