...
function deleteItem() {
    if (selectedId.value) {
        router.delete(route('provinces.destroy', selectedId.value), {
            preserveScroll: true,
            onSuccess: () => {
...
<template>
    <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem v-if="can.read_province" class="p-0">
                <Link :href="route('provinces.show', province.id)" class="w-full">
            ...
            <DropdownMenuItem v-if="can.update_province" class="p-0">
                <Link :href="route('provinces.edit', province.id)" class="w-full">
            ...
            <DropdownMenuItem v-if="can.delete_province" class="p-0">
                <Button variant="ghost" size="sm" :title="trans('ui.delete')" @click="confirmDelete(province.id)"
