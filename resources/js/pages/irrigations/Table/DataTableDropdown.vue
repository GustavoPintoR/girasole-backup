...
function deleteItem() {
    if (selectedId.value) {
        router.delete(route('irrigations.destroy', selectedId.value), {
            preserveScroll: true,
            onSuccess: () => {
...
<template>
    <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem v-if="can.read_irrigation" class="p-0">
                <Link :href="route('irrigations.show', props.irrigation.id)" class="w-full">
            ...
            <DropdownMenuItem v-if="can.update_irrigation" class="p-0">
                <Link :href="route('irrigations.edit', props.irrigation.id)" class="w-full">
            ...
            <DropdownMenuItem v-if="can.delete_irrigation" class="p-0">
                <Button variant="ghost" size="sm" :title="trans('ui.delete')" @click="confirmDelete(props.irrigation.id)"
