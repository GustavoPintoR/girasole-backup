...
function deleteItem() {
    if (selectedId.value) {
        router.delete(route('permissions.destroy', selectedId.value), {
            preserveScroll: true,
            onSuccess: () => {
...
<template>
    <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem v-if="can.read_permission" class="p-0">
                <Link :href="route('permissions.show', permission.id)" class="w-full">
            ...
            <DropdownMenuItem v-if="can.update_permission" class="p-0">
                <Link :href="route('permissions.edit', permission.id)" class="w-full">
            ...
            <Button v-if="can.delete_permission" variant="ghost" size="sm" :title="trans('ui.delete')" @click="confirmDelete(permission.id)"
