...
function deleteItem() {
    if (selectedId.value) {
        router.delete(route('cities.destroy', selectedId.value), {
            preserveScroll: true,
            onSuccess: () => {
...
<template>
    <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem v-if="can.read_city" class="p-0">
                <Link :href="route('cities.show', props.city.id)" class="w-full">
            ...
            <DropdownMenuItem v-if="can.update_city" class="p-0">
                <Link :href="route('cities.edit', props.city.id)" class="w-full">
            ...
            <DropdownMenuItem v-if="can.delete_city" class="p-0">
                <Button variant="ghost" size="sm" :title="trans('ui.delete')" @click="confirmDelete(props.city.id)"
