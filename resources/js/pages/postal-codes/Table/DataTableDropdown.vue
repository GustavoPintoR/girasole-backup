...
function deleteItem() {
    if (selectedId.value) {
        router.delete(route('postal-codes.destroy', selectedId.value), {
            preserveScroll: true,
            onSuccess: () => {
...
<template>
    <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem v-if="can.read_postal_code" class="p-0">
                <Link :href="route('postal-codes.show', postalCode.id)" class="w-full">
            ...
            <DropdownMenuItem v-if="can.update_postal_code" class="p-0">
                <Link :href="route('postal-codes.edit', postalCode.id)" class="w-full">
            ...
            <Button v-if="can.delete_postal_code" variant="ghost" size="sm" :title="trans('ui.delete')" @click="confirmDelete(postalCode.id)"
