...
function deleteItem() {
    if (selectedId.value) {
        router.delete(route('sensor-fields.destroy', selectedId.value), {
            preserveScroll: true,
            onSuccess: () => {
...
<template>
    <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem v-if="can.read_sensor_field" class="p-0">
                <Link :href="route('sensor-fields.show', sensorField.id)" class="w-full">
            ...
            <DropdownMenuItem v-if="can.update_sensor_field" class="p-0">
                <Link :href="route('sensor-fields.edit', sensorField.id)" class="w-full">
            ...
            <Button
                v-if="can.delete_sensor_field"
                variant="ghost"
                size="sm"
                :title="trans('ui.delete')"
                @click="confirmDelete(sensorField.id)"
