...
function deleteItem() {
    if (selectedId.value) {
        router.delete(route('planting-schemes.destroy', selectedId.value), {
            preserveScroll: true,
            onSuccess: () => {
...
<template>
    <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem v-if="can.read_planting_scheme" class="p-0">
                <Link :href="route('planting-schemes.show', plantingScheme.id)" class="w-full">
            ...
            <DropdownMenuItem v-if="can.update_planting_scheme" class="p-0">
                <Link :href="route('planting-schemes.edit', plantingScheme.id)" class="w-full">
            ...
            <Button v-if="can.delete_planting_scheme" variant="ghost" size="sm" :title="trans('ui.delete')" @click="confirmDelete(plantingScheme.id)"
