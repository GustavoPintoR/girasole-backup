...
function deleteItem() {
    if (selectedId.value) {
        router.delete(route('cultivations.destroy', selectedId.value), {
            preserveScroll: true,
            onSuccess: () => {
...
<template>
    <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem v-if="can.read_cultivation" class="p-0">
                <Link :href="route('cultivations.show', props.cultivation.id)" class="w-full">
            ...
            <DropdownMenuItem v-if="can.update_cultivation" class="p-0">
                <Link :href="route('cultivations.edit', props.cultivation.id)" class="w-full">
            ...
            <DropdownMenuItem v-if="can.delete_cultivation" class="p-0">
                <Button variant="ghost" size="sm" :title="trans('ui.delete')" @click="confirmDelete(props.cultivation.id)"
