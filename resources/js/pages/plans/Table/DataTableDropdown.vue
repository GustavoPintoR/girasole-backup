...
function deleteItem() {
    if (selectedId.value) {
        router.delete(route('plans.destroy', selectedId.value), {
            preserveScroll: true,
            onSuccess: () => {
...
<template>
    <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem v-if="can.read_plan" class="p-0">
                <Link :href="route('plans.show', props.plan.id)" class="w-full">
            ...
            <DropdownMenuItem v-if="can.update_plan" class="p-0">
                <Link :href="route('plans.edit', props.plan.id)" class="w-full">
            ...
            <DropdownMenuItem v-if="can.delete_plan" class="p-0">
                <Button variant="ghost" size="sm" :title="trans('ui.delete')" @click="confirmDelete(props.plan.id)"
