...
function deleteItem() {
    if (selectedId.value) {
        router.delete(route('sensor-types.destroy', selectedId.value), {
            preserveScroll: true,
            onSuccess: () => {
...
<template>
    <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem v-if="can.read_sensor_type" class="p-0">
                <Link :href="route('sensor-types.show', sensorType.id)" class="w-full">
            ...
            <DropdownMenuItem v-if="can.update_sensor_type" class="p-0">
                <Link :href="route('sensor-types.edit', sensorType.id)" class="w-full">
            ...
            <Button
                v-if="can.delete_sensor_type"
                variant="ghost"
                size="sm"
                :title="trans('ui.delete')"
                @click="confirmDelete(sensorType.id)"
