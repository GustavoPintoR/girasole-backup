...
export const columns: ColumnDef<any>[] = [
    ...
    },
    {
        ...
        header: () =>
        h('div', { class: 'flex items-center text-center justify-center w-full' }, trans('ui.cultivation')),
        cell: ({ row }) => {
        const cultivationName = row.original.cultivation?.name ?? '—';
        return h('div', { class: 'text-center font-medium' }, cultivationName);
        },
        enableSorting: false,
    },
    {
