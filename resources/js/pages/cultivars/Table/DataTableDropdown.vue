...
function deleteItem() {
    if (selectedId.value) {
        router.delete(route('cultivars.destroy', selectedId.value), {
            preserveScroll: true,
            onSuccess: () => {
...
<template>
    <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem v-if="can.read_cultivar" class="p-0">
                <Link :href="route('cultivars.show', props.cultivar.id)" class="w-full">
            ...
            <DropdownMenuItem v-if="can.update_cultivar" class="p-0">
                <Link :href="route('cultivars.edit', props.cultivar.id)" class="w-full">
            ...
            <DropdownMenuItem v-if="can.delete_cultivar" class="p-0">
                <Button variant="ghost" size="sm" :title="trans('ui.delete')" @click="confirmDelete(props.cultivar.id)"
