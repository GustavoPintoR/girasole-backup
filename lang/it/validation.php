...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'custom_fields.*' => [
            ...
            'integer' => 'Questo campo deve essere un numero.',
            'numeric' => 'Questo campo deve essere un numero.',
            'date' => 'Questo campo deve essere una data valida.',
            'in' => 'L\'opzione selezionata non è valida.',
    ...
    */
    ...
    'attributes' => [
        ...
        'active' => 'attivo',
        'role' => 'ruolo',
        'same_as_billing' => 'utilizzare l\'indirizzo di fatturazione',
        'shipping_region_id' => 'regione di spedizione',
        'shipping_province_id' => 'provincia di spedizione',
        'shipping_city_id' => 'città di spedizione',
